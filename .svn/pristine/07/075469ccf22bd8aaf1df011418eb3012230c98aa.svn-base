                            ...
                            <fieldset>
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <asp:TextBox ID="txtAutoComplete" runat="server" MaxLength="50" Width="252px"> </asp:TextBox>
                                    ...
                                    <asp:GridView ID="gvRequisition" CssClass="table table-striped table-hover" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Quantity" HeaderStyle-CssClass="danger">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQty" runat="server" MaxLength="3" Width="50px" Text='<%#Eval("ReqQuantityReq")%>' onkeypress="return isNumberKey(event);"   OnTextChanged="txtQty_TextChanged"  />
