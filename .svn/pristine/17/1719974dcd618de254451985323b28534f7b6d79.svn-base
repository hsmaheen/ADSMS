<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/Department/DepHead.Master" AutoEventWireup="true" CodeBehind="StationeryCollectionDetails_head.aspx.cs" Inherits="ADSMS.Presentation.Department.StationeryCollectionDetails_head" %>
                    ...
                    <div class="well">
                        <div class="bs-example form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label2" CssClass="col-lg-4 control-label" runat="server" Text="Department's Contact Name:"></asp:Label>
                                    <div class="col-lg-6">
                                        <asp:TextBox ID="txtDeptContactName" runat="server" CssClass="form-control" MaxLength="45" ValidationGroup="CollectionPoint"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvContactName" runat="server" ControlToValidate="txtDeptContactName" ErrorMessage="*Please Fill" ForeColor="Red" ValidationGroup="CollectionPoint" CssClass="control-label">*Please Fill</asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:TextBox ID="txtDeptContactNum" runat="server" CssClass="form-control" pattern="^[0-9]+$" MaxLength="8"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvContactNo" runat="server" ErrorMessage="*Please Fill" ControlToValidate="txtDeptContactNum" CssClass="control-label" ForeColor="Red" ValidationGroup="CollectionPoint">*Please Fill</asp:RequiredFieldValidator>
                                ...
                                <div class="form-group">
                                   ...
                                   <asp:LinkButton ID="lnkbtnChangeDeptRepName" runat="server" OnClick="lnkbtnChangeDeptRepName_Click" CssClass="col-lg-2 control-label">Change Representative</asp:LinkButton>
                                    <%--<asp:LinkButton ID="lnkbtnDelete" runat="server" CssClass="col-lg-2 control-label" OnClick="lnkbtnDelete_Click">Delete</asp:LinkButton>--%>
                                   <asp:LinkButton ID="lnkbtnCancel" runat="server" OnClick="lnkbtnCancel_Click" CssClass="col-lg-2 control-label">Cancel</asp:LinkButton>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-10 col-lg-offset-4">
                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnSubmit_Click" ValidationGroup="CollectionPoint" />
