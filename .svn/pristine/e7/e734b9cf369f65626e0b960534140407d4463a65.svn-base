                        ...
                        <form id="login" runat="server">
                         <%--   <asp:ScriptManager ID="ScriptManager1" runat="server" />
                            <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="0">
                                <ProgressTemplate>
                                    <div style="position: absolute; width: 100%; height: 100%; z-index: 100; background-color: Gray; filter: alpha(opacity=70); opacity: 0.7;">
                                        &nbsp;
                                    </div>
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <div style="color: Black; font-weight: bolder; background-color: White; padding: 15px; width: 200px;">
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="../Design/ajaxloader.gif" />
                                                    Please wait....
                                                </div>
                                            </td>
                                        </tr>
