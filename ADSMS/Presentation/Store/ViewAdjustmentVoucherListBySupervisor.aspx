        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <%--<table style="width:100%;">--%>
                    ...
                    <asp:GridView ID="dgvStockAdjustmentList" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-striped table-bordered table-responsive" EmptyDataText="No Adjustment " >
                        <Columns>
