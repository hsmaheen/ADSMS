    ...
    <div class="container">
        <div class="jumbotron">
            <div class="row">
                ...
                <asp:Panel ID="PanelErrorSave" runat="server" CssClass="alert alert-dismissable alert-danger" Visible="False">
                    <strong>Sorry! </strong><asp:Label ID="lblErrorSave" runat="server" Text=""></asp:Label>
                </asp:Panel>
                ...
                <asp:Panel ID="PanelCancel" runat="server" CssClass="alert alert-dismissable alert-success" Visible="False">
                    <strong>Canceled! </strong>This delegation has been canceled.</asp:Panel>
                        ...
                        <div class="bs-example form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="dpd1" name="dpd1" type="text" value="<%= this.FromDate %>" required pattern="^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d$" placeholder="From date" class="form-control"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input id="dpd2" name="dpd2" type="text" value="<%= this.ToDate %>" required pattern="^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d$" placeholder="To date" class="form-control"/>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-10 col-lg-offset-4">
                                        <asp:Button ID="btnSubmitDeligation" runat="server" Text="Submit Delegation" CssClass="btn btn-primary" OnClick="btnSubmitDeligation_Click" Enabled="False" />
                                        <asp:Button ID="btnResetDelegation" runat="server" Text="Cancel Delegation" CssClass="btn btn-default" OnClick="btnResetDelegation_Click" Enabled="False" />
                                    </div>
                                </div>
                            </fieldset>
                        </div>
